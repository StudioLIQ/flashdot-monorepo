...
export function LoanStatus({ loan, legs, refreshing, loading, onRepaid }: LoanStatusProps): JSX.Element {
    ...
    return (
      <section className="mt-8 rounded-2xl border border-ink/15 bg-white p-6 dark:border-white/10 dark:bg-white/5">
        <EmptyState
          ...
          description="Create a bonded flash loan to get started. One signature locks the bond and starts execution."
          action={{ label: "Create Flash Loan", href: "/create" }}
        />
      </section>
    );
  }
  ...
  return (
    <section className="elevation-1 mt-8 rounded-2xl p-6" aria-labelledby="loan-status-title" aria-live="polite" aria-relevant="additions text">
      <div className="flex items-center justify-between gap-3">
